	...
	"methods": [
		{
			...
			"html": "<p>Applies the access to the current page. When showQuery and hideQuery are\n provided, then these will be used to apply the access, when not provided, the\n previous values will be used.</p>\n<p>Generallly, the index page defines the showQuery and hideQuery values via the\n checkbox actions, and the content pages rely on sending the arguments to the\n function to apply the access to the page.</p>",
			"entity": "method",
		...
		},
		{
			...
			"html": "<p>THe handler pinged when a content page is loaded to check to see what the access whoudl be on\n the page.</p>",
			"entity": "method",
