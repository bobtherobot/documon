		...
		"flags": [
			{
				...
				"shortText": "descr",
				"shortHtml": "<p>descr</p>",
				"html": "<p>descr <br>\n         after yields: <br>\n            {type} name descr</p>\n\n<ul>\n<li><p><strong>name</strong> :        The first word following the {type} definition. Or the first word after the @flag definition</p></li>\n<li><p><strong>children</strong> :    If a name is written as foo.bar then foo is the parent and bar is a child. Future processing fills the array forming a heirarchy.</p></li>\n<li><strong>parent</strong> :      The parent flag of a child. This property only exists on children flags.</li>\n<li><strong>defaultVal</strong> :  When name=foo then default value will be foo. Note that quotes are stripped. <br>\n            e.g. foo=\"bar\" sets default property to \"bar\" (without the quotes) and name property to \"foo\".</li>\n<li><strong>flag</strong> :        The flag kind - the @ is stripped</li>\n<li><strong>afterType</strong> :   Everything after the {type} definition <br>\n            e.g. @flag {type} name - descr <br>\n                ... yields: <br>\n                name - descr</li>\n<li><strong>text</strong> :        The description for the paramter. Note that additional description text can be provided below the @flag. <br>\n                e.g. @flag {type} name - description <br>\n                more description <br>\n                below the flag here</li>\n</ul>"
			},
			{
