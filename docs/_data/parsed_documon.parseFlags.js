[
	...
	},
	{
		...
		"flags": [
			{
				"source": "@property {array} DOTTED_CHILD_TAGS - Tags where a dotted name means \"member of\",",
				"flag": "property",
				"after": "{array} DOTTED_CHILD_TAGS - Tags where a dotted name means \"member of\",",
				"type": "array",
				"afterType": "DOTTED_CHILD_TAGS - Tags where a dotted name means \"member of\",",
				"name": "DOTTED_CHILD_TAGS",
				"text": "Tags where a dotted name means \"member of\",\nrather than a fully qualified id. Only these get parent/child treatment."
			}
		],
		"source": "@property {array} DOTTED_CHILD_TAGS - Tags where a dotted name means \"member of\",\nrather than a fully qualified id. Only these get parent/child treatment.",
		"meta": [],
