[
	...
	{
		"text": "Builds the \"more\" pages and merges them into the menu. See the class description\nfor what the module does as a whole.\n\n",
		"start": 243,
		"end": 259,
		"file": "/Volumes/Drives/projects/documon/documon/src/more.js",
		"flags": [
			...
			{
				"source": "@param      {function}  [shouldIgnore]\t\t\t\t\t- The ignore matcher, so the more folder honours the same ignore list as the source tree.The ignore matcher, so the more folder honours the same ignore list as the source tree.",
				"flag": "param",
				"after": "{function}  [shouldIgnore]\t\t\t\t\t- The ignore matcher, so the more folder honours the same ignore list as the source tree.",
				"type": "function",
				"afterType": "[shouldIgnore]\t\t\t\t\t- The ignore matcher, so the more folder honours the same ignore list as the source tree.",
				"optional": true,
				"name": "shouldIgnore",
				"text": "The ignore matcher, so the more folder honours the same ignore list as the source tree."
			},
			{
	...
	},
	{
		...
		"flags": [
			...
			{
				"source": "@param   {string} relative    - Path relative to the more folder, e.g. \"104.Options.md\".Path relative to the more folder, e.g. \"104.Options.md\".",
				"flag": "param",
				"after": "{string} relative    - Path relative to the more folder, e.g. \"104.Options.md\".",
				"type": "string",
				"afterType": "relative    - Path relative to the more folder, e.g. \"104.Options.md\".",
				"name": "relative",
				"text": "Path relative to the more folder, e.g. \"104.Options.md\"."
			},
			{
				"source": "@param   {string} [delimiter] - The moreQuirkDelimiter; defaults to the module's.The moreQuirkDelimiter; defaults to the module's.",
				"flag": "param",
				"after": "{string} [delimiter] - The moreQuirkDelimiter; defaults to the module's.",
				"type": "string",
				"afterType": "[delimiter] - The moreQuirkDelimiter; defaults to the module's.",
				"optional": true,
				"name": "delimiter",
				"text": "The moreQuirkDelimiter; defaults to the module's."
			},
			{
				"source": "@return  {string} The dotted id, e.g. \"more.options\".",
				"flag": "return",
				"after": "{string} The dotted id, e.g. \"more.options\".",
				"type": "string",
				"afterType": "The dotted id, e.g. \"more.options\".",
				"name": "The",
				"text": "dotted id, e.g. \"more.options\"."
			}
		],
		"source": "Derives the id a \"more\" file will be filed under, without building anything.\n\n`check.js` uses this so a cross-link to a prose page resolves the same way the\nsite resolves it. The derivation must live in one place -- a second copy would\ndrift and start reporting working links as broken.\n\n@method  pageId\n@param   {string} relative    - Path relative to the more folder, e.g. \"104.Options.md\".\n@param   {string} [delimiter] - The moreQuirkDelimiter; defaults to the module's.\n@return  {string} The dotted id, e.g. \"more.options\".",
		"meta": [],
