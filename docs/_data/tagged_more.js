{
	...
	"methods": [
		...
		},
		{
			...
			"params": [
				...
				{
					"name": "shouldIgnore",
					"shortText": "The ignore matcher, so the more folder honours the same ignore list as the source tree.",
					"shortHtml": "<p>The ignore matcher, so the more folder honours the same ignore list as the source tree.</p>",
					"text": "The ignore matcher, so the more folder honours the same ignore list as the source tree.",
					"html": "<p>The ignore matcher, so the more folder honours the same ignore list as the source tree.</p>",
					"type": "function",
					"optional": true
				}
			],
		...
		},
		{
			"line": 461,
			"name": "pageId",
			"shortText": "Derives the id a \"more\" file will be filed under, without building anything.",
			"shortHtml": "<p>Derives the id a \"more\" file will be filed under, without building anything.</p>",
			...
			"html": "<p>Derives the id a \"more\" file will be filed under, without building anything.</p>\n<p><code>check.js</code> uses this so a cross-link to a prose page resolves the same way the<br />\nsite resolves it. The derivation must live in one place -- a second copy would<br />\ndrift and start reporting working links as broken.</p>",
			"entity": "method",
			"flagSearchText": " pageId Path relative to the more folder, e.g. \"104.Options.md\". The moreQuirkDelimiter; defaults to the module's. dotted id, e.g. \"more.options\".",
			"params": [
				{
					"name": "relative",
					"shortText": "Path relative to the more folder, e.g. \"104.Options.md\".",
					"shortHtml": "<p>Path relative to the more folder, e.g. \"104.Options.md\".</p>",
					"text": "Path relative to the more folder, e.g. \"104.Options.md\".",
					"html": "<p>Path relative to the more folder, e.g. \"104.Options.md\".</p>",
					"type": "string"
				},
				{
					"name": "delimiter",
					"shortText": "The moreQuirkDelimiter; defaults to the module's.",
					"shortHtml": "<p>The moreQuirkDelimiter; defaults to the module's.</p>",
					"text": "The moreQuirkDelimiter; defaults to the module's.",
					"html": "<p>The moreQuirkDelimiter; defaults to the module's.</p>",
					"type": "string",
					"optional": true
				}
			],
			"returns": {
				"type": "string",
				"text": "The dotted id, e.g. \"more.options\".",
				"html": "<p>The dotted id, e.g. \"more.options\".</p>",
				"shortText": "<p>The dotted id, e.g. \"more.options\".</p>",
				"shortHtml": "<p>The dotted id, e.g. \"more.options\".</p>"
			},
			"file": "src/more.js",
			"filename": "more.js",
			"klass": "More",
	...
	"search": {
		"documon.More": "More : Discovers parses converts markdown HTML injects menu with more docs Processes more markdown folder Building menu reflect more folder directory structure Translates markdown into HTML work done init init which what this module exportsMore documon",
		...
		"documon.More.init": "init : Builds more pages merges them into menu class description what module does wholeinit primary documon configuration documon mainConf documon documon mainConf which should contain menu parsed source code documentation merge into more menu searchData local documon documon documon function generated seeder documon documon seeder include more docs searching ignore matcher more folder honours same ignore list source tree Serves purposes when returning undefined notifies callee that there aren more docs Otherwise modified menu return with original sourceDocsMenu either tacked onto more menu incorporated into more menu DOCS HERE injection point",
		"documon.More.pageId": "pageId : Derives more file will filed under without building anything check uses this cross link prose page resolves same site resolves derivation must live place second copy would drift start reporting working links brokenpageId Path relative more folder Options moreQuirkDelimiter defaults module dotted more options",
