[
	{
		...
		"start": 7,
		"end": 12,
		"file": "/Volumes/Drives/projects/documon/documon/src/fileutils.js",
		"flags": [
			{
	...
	},
	{
		...
		"flags": [
			...
			{
				"source": "@param      {string}    src     - The source file path.The source file path.",
				"flag": "param",
				"after": "{string}    src     - The source file path.",
				"type": "string",
				"afterType": "src     - The source file path.",
				"name": "src",
				"text": "The source file path."
			},
			{
				"source": "@param      {string}    dest    - The destination to copy the source to.",
				"flag": "param",
				"after": "{string}    dest    - The destination to copy the source to.",
				"type": "string",
				"afterType": "dest    - The destination to copy the source to.",
				"name": "dest",
	...
	},
	{
		...
		"flags": [
			...
			{
				"source": "@return     {string}           description",
				"flag": "return",
	...
	},
	{
		...
		"flags": [
			...
			{
				"source": "@param      {string}    data    - The text data to save.",
				"flag": "param",
				"after": "{string}    data    - The text data to save.",
				"type": "string",
				"afterType": "data    - The text data to save.",
				"name": "data",
	...
	},
	{
		...
		"flags": [
			...
			{
				"source": "@param      {string}    src    - The source file path.",
				"flag": "param",
				"after": "{string}    src    - The source file path.",
				"type": "string",
				"afterType": "src    - The source file path.",
	...
	},
	{
		...
		"flags": [
			...
			{
				"source": "@param      {type}    src    - The source file path.The source file path.",
				"flag": "param",
				"after": "{type}    src    - The source file path.",
				"type": "type",
				"afterType": "src    - The source file path.",
				"name": "src",
				"text": "The source file path."
			...
			{
				"source": "@return     {boolean}           - True if exists, false if no file nor folder exists.",
				"flag": "return",
				"after": "{boolean}           - True if exists, false if no file nor folder exists.",
				"type": "boolean",
				"afterType": "True if exists, false if no file nor folder exists.",
