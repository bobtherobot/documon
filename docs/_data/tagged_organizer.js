{
	...
	"methods": [
		...
		},
		{
			...
			"entity": "method",
			"flagSearchText": " init The configuration options sent in by the user during [documon.documon.mainConf](documon.documon.mainConf). We keep a refence here so we know where to put things. Note that documon derives some additional properties onto the object.",
			"params": [
				{
					"name": "params",
					"shortText": "The configuration options sent in by the user during [documon.documon.mainConf](documon.documon.mainConf). We keep a refence here so we know where to put things. Note that documon derives some additional properties onto the object.",
					"shortHtml": "<p>The configuration options sent in by the user during <a href=\"documon.documon.mainConf\">documon.documon.mainConf</a>. We keep a refence here so we know where to put things. Note that documon derives some additional properties onto the object.</p>",
					...
					"html": "<p>The configuration options sent in by the user during <a href=\"documon.documon.mainConf\">documon.documon.mainConf</a>. We keep a refence here so we know where to put things. Note that documon derives some additional properties onto the object.</p>",
					"type": "type",
					"children": [
						{
							"name": "templateFolder",
	...
	"properties": [
		...
		},
		{
			"line": 80,
			"name": "mainConf",
			"shortText": "A reference to the main configuration object. See [documon.documon.mainConf](documon.documon.mainConf).",
			"shortHtml": "<p>A reference to the main configuration object. See <a href=\"documon.documon.mainConf\">documon.documon.mainConf</a>.</p>",
			"text": "A reference to the main configuration object. See [documon.documon.mainConf](documon.documon.mainConf).",
			"html": "<p>A reference to the main configuration object. See <a href=\"documon.documon.mainConf\">documon.documon.mainConf</a>.</p>",
			"type": "Object",
			"entity": "property",
			"flagSearchText": " A reference to the main configuration object. See [documon.documon.mainConf](documon.documon.mainConf).",
			"file": "src/organizer.js",
			"filename": "organizer.js",
			"klass": "organizer",
			"package": "documon",
	...
	"search": {
		...
		"documon.organizer.init": "init : Initializes organ which object that inserting tagged data into also grabbing templates needed based location defined paramsinit configuration options sent user during documon documon mainConf documon documon mainConf keep refence here know where things Note that documon derives some additional properties onto object",
		...
		"documon.organizer.mainConf": "mainConf : reference main configuration object documon documon mainConf documon documon mainConfreference main configuration object documon documon mainConf documon documon mainConf",
