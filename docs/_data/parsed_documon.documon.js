[
	...
	},
	{
		...
		"flags": [
			{
				"source": "@property {object} tally - Counts of tags that were normalized or ignored during a",
				"flag": "property",
				"after": "{object} tally - Counts of tags that were normalized or ignored during a",
				"type": "object",
				"afterType": "tally - Counts of tags that were normalized or ignored during a",
				"name": "tally",
				"text": "Counts of tags that were normalized or ignored during a\nbuild, reported as a single line when the build finishes."
			}
		],
		"source": "@property {object} tally - Counts of tags that were normalized or ignored during a\nbuild, reported as a single line when the build finishes.",
		"meta": [],
